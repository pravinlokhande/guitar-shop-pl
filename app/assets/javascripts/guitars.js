...
$(document).ready(function() {
  "use strict";
  function boostapGrowl(msg, type) {
	$.bootstrapGrowl('Error occurred.', {
	  ele: 'body',
	  type: 'danger',
	  width: 'auto',
	  delay: 30000,
...
$(document).ready(function() {
	$("input[id^='add_to_cart_']").click(function (e) {
	  e.preventDefault();
	  
	  var guitar = $("input[id^='add_to_cart_']").val()
	  console.log('guitars', guitar);
	});

	$('#invite-more').click(function (e) {
	    e.preventDefault();
	    $('#invite-wrapper').append(
	      '<div class="invite-group row">'+
	        '<div class="col-md-12">'+
	          '<div class="col-md-4 no-padding padding-right-5">'+
